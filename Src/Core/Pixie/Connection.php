...
class Connection
{
    ...
    public function __construct($adapter, array $adapterConfig, $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\Core\\Pixie\\EventHandler');
    ...
    {
        class_alias('\\Core\\Pixie\\AliasFacade', $alias);
        $builder = $this->container->build('\\Core\\Pixie\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\Core\\Pixie\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
    ...
    protected function connect()
    {
        ...
        $adapter = '\\Core\\Pixie\\ConnectionAdapters\\' . ucfirst(strtolower($this->adapter));
