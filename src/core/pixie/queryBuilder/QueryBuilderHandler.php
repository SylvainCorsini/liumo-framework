...
class QueryBuilderHandler
{
    ...
    /**
     * @var \Core\Pixie\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\Core\Pixie\Connection $connection
     *
     * @throws \Core\Pixie\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\Core\\Pixie\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function getQuery($type = 'select', $dataToBePassed = array())
    {
        ...
        return $this->container->build(
            '\\Core\\Pixie\\QueryBuilder\\QueryObject',
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\Core\\Pixie\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build('\\Core\\Pixie\\QueryBuilder\\Transaction', array($this->connection));
