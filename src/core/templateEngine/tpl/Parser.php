<?php
namespace Core\TemplateEngine\TPL;
...
class Parser
{
    ...
    public function compileFile(
        ...
        if (flock($fp, LOCK_EX)) {
            ...
            $parsedCode = "<?php if(!class_exists('Core\\TemplateEngine\\TemplateEngine')){exit;}?>" . $parsedCode;
    ...
    public function compileString($templateName, $templateBasedir, $templateFilepath, $parsedTemplateFilepath, $code) {
        ...
        if (flock($fp, LOCK_SH)) {
            ...
            $parsedCode = "<?php if(!class_exists('Core\\Rain\\Rain')){exit;}?>" . $parsedCode;
