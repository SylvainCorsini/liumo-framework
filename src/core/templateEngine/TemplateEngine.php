...
class TemplateEngine
{
    ...
    public function __construct($config = null, $alias = null)
    {
        ...
        if (!empty($alias)) {
            class_alias('Core\\TemplateEngine\\AliasFacade', $alias);
        }
    }
     ...
     * @throw TPL\NotFoundException the file doesn't exists
