<?php
namespace Core\QueryBuilder\QB;

use PDO;
use Core\QueryBuilder\Connection;
use Core\QueryBuilder\Exception;
...
class QueryBuilderHandler
{
    ...
    /**
     * @var \Core\QueryBuilder\QB\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\Core\QueryBuilder\Connection $connection
     *
     * @throws \Core\QueryBuilder\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\Core\\QueryBuilder\\QB\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function getQuery($type = 'select', $dataToBePassed = array())
    {
        ...
        return $this->container->build(
            '\\Core\\QueryBuilder\\QB\\QueryObject',
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\Core\\QueryBuilder\\QB\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build('\\Core\\QueryBuilder\\QB\\Transaction', array($this->connection));
    ...
    {
        return $this->container->build('\\Core\\Pixie\\QueryBuilder\\Raw', array($value, $bindings));
    }
