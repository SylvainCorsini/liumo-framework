...
class Connection
{
    ...
    public function __construct($adapter, array $adapterConfig, $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\Core\\QueryBuilder\\EventHandler');
    ...
    {
        class_alias('\\Core\\QueryBuilder\\AliasFacade', $alias);
        $builder = $this->container->build('\\Core\\QueryBuilder\\QB\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\Core\\QueryBuilder\\QB\\QueryBuilderHandler', array($this));
    }
    ...
    protected function connect()
    {
        ...
        $adapter = '\\Core\\QueryBuilder\\ConnectionAdapters\\' . ucfirst(strtolower($this->adapter));
